...
pub mod erc_20_token {
    ...
    impl ::core::fmt::Display for Erc20TokenEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::TokenTransferFilter(element) => {
    ...
    impl ::ethers::core::abi::AbiDecode for Erc20TokenCalls {
        fn decode(
            ...
            if let Ok(decoded) = <BatchMintCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <TokenTransferCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
