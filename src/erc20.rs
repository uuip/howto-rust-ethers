...
pub mod erc_20_token {
    const _: () = {
        ::core::include_bytes!("/Users/sharp/Desktop/rust/web3action/erc20_abi.json");
    };
    #[allow(deprecated)]
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("batchMint"),
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("batchMint"),
                        inputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
    ...
    impl<M> ::core::fmt::Debug for Erc20Token<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Erc20Token))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Erc20Token<M> {
        ...
        ///Calls the contract's `batchMint` (0x83b74baa) function
        pub fn batch_mint(
            &self,
            ...
            self.0
                .method_hash([131, 183, 75, 170], (to, amount))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `tokenTransfer` (0x1c2004b2) function
        pub fn token_transfer(
            ...
            self.0
                .method_hash([28, 32, 4, 178], (to, amount, message))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Gets the contract's `TokenTransfer` event
        pub fn token_transfer_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, TokenTransferFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, Erc20TokenEvents> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for Erc20Token<M> {
    ...
    #[ethevent(name = "TokenTransfer", abi = "TokenTransfer(address,uint256,string)")]
    ...
    impl ::ethers::contract::EthLogDecode for Erc20TokenEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = TokenTransferFilter::decode_log(log) {
                return Ok(Erc20TokenEvents::TokenTransferFilter(decoded));
            }
    ...
    impl ::core::fmt::Display for Erc20TokenEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::TokenTransferFilter(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<TokenTransferFilter> for Erc20TokenEvents {
        fn from(value: TokenTransferFilter) -> Self {
            Self::TokenTransferFilter(value)
        }
    }
    ...
    ///Container type for all input parameters for the `batchMint` function with signature `batchMint(address[],uint256)` and selector `0x83b74baa`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "batchMint", abi = "batchMint(address[],uint256)")]
    ...
    ///Container type for all input parameters for the `tokenTransfer` function with signature `tokenTransfer(address,uint256,string)` and selector `0x1c2004b2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "tokenTransfer", abi = "tokenTransfer(address,uint256,string)")]
    ...
    pub enum Erc20TokenCalls {
        ...
        Name(NameCall),
        Symbol(SymbolCall),
        TokenTransfer(TokenTransferCall),
    ...
    impl ::ethers::core::abi::AbiDecode for Erc20TokenCalls {
        fn decode(
            ...
            if let Ok(decoded) = <BatchMintCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <TokenTransferCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for Erc20TokenCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::BatchMint(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::convert::From<BatchMintCall> for Erc20TokenCalls {
    ...
    impl ::core::convert::From<TokenTransferCall> for Erc20TokenCalls {
        fn from(value: TokenTransferCall) -> Self {
    ...
    ///Container type for all return fields from the `tokenTransfer` function with signature `tokenTransfer(address,uint256,string)` and selector `0x1c2004b2`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct TokenTransferReturn(pub bool);
